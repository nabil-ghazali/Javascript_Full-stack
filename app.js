...
app.get('/api/stuff', (req, res, next) => {
 ...
 // Route permettant de modifier un objets Thing de la base de données
app.put('/api/stuff/:id', (req, res, next) => {
  ...
  // Route permettant de supprimer un objets Thing de la base de données
  app.delete('/api/stuff/:id', (req, res, next) => { 
    Thing.deleteOne({_id: req.params.id}, {_id: req.params.id}) 
